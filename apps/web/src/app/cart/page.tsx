  ...
  if (items.length === 0) {
    return (
      <div className="bg-[#f8f9fa] min-h-screen flex flex-col items-center justify-center p-4">
        <button onClick={() => router.push("/")} className="absolute top-6 left-4 flex items-center gap-2 text-sm font-bold text-gray-500">
        ...
        <button onClick={() => router.push("/")} className="bg-primary text-white font-bold px-6 py-2.5 rounded-xl active:scale-95 transition-transform">
          Browse Menu
        </button>
      </div>
    );
