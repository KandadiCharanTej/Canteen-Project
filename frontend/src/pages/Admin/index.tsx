  ...
  if (!isLoggedIn || user?.role !== "admin") {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen p-4 text-center">
        ...
        <button onClick={() => navigate("/")} className="bg-primary text-white px-6 py-2 rounded-xl font-bold">
          Go Home
        </button>
      </div>
    );
  ...
  return (
    <div className="bg-[#f8f9fa] min-h-screen pb-24 md:pb-12">
      <div className="bg-white border-b border-gray-100 px-4 py-4 flex items-center justify-between md:hidden">
         ...
         <button onClick={() => navigate("/")} className="text-xs font-bold text-gray-400 flex items-center gap-1">
