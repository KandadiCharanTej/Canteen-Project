      ...
      <header className="sticky top-0 z-30 bg-background/90 glass-blur border-b border-border/60">
        <div className="mx-auto max-w-5xl px-4 h-14 flex items-center gap-3">
          <Link to="/admin" className="flex items-center gap-2">
            <div className="h-8 w-8 rounded-xl gradient-primary grid place-items-center text-white text-xs font-bold">
              QB
            </div>
          ...
          <nav className="ml-auto flex items-center gap-1">
            ...
            <button
              onClick={logout}
              className="ml-1 inline-flex items-center gap-1.5 h-9 px-2.5 rounded-lg text-[13px] text-muted-foreground hover:text-destructive hover:bg-destructive/10 transition"
            >
