      ...
      <div className="mx-auto max-w-6xl px-4 pt-3">
        ...
        >
          <div className="relative z-10 flex items-center justify-between gap-3">
            <div>
              ...
              <h1 className="mt-1.5 text-[19px] sm:text-2xl font-bold leading-tight text-balance">
                Skip the Queue <span className="inline-block">🍱</span>
          ...
          <div className="mt-3 flex items-center gap-3 text-[11px] text-muted-foreground">
            <span className="inline-flex items-center gap-1">
              <Clock className="h-3 w-3 text-primary" /> Ready in 10 min
            </span>
            <span className="inline-flex items-center gap-1">
              <ShieldCheck className="h-3 w-3 text-success" /> OTP pickup
            </span>
            <span className="inline-flex items-center gap-1">
              <Zap className="h-3 w-3 text-warning" /> UPI ready
            </span>
          </div>
        ...
        <section className="mt-4">
          <div className="flex items-center justify-between mb-2">
            ...
            <Link to="/orders" className="text-[11px] text-primary font-medium">
              My orders →
            </Link>
          </div>
