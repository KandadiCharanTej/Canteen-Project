      ...
      <div className="flex items-center justify-between mb-3">
        <div>
          ...
          <p className="text-[11px] text-muted-foreground">
            {foods.length} items · tap any to edit
          </p>
        </div>
        <button
          onClick={() => setOpen({})}
          className="inline-flex items-center gap-1.5 h-10 px-3.5 rounded-xl bg-primary text-primary-foreground font-semibold text-sm active:scale-[0.98]"
        >
          ...
          >
            <div className="relative h-20 w-20 rounded-lg overflow-hidden bg-muted shrink-0">
              <img
                src={f.image}
                alt={f.name}
                className={cn("h-full w-full object-cover", !f.inStock && "grayscale opacity-60")}
              />
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="mt-1.5 flex items-center gap-1.5">
                <button
                  ...
                  className={cn(
                    "h-7 px-2 rounded-md text-[10px] font-semibold uppercase tracking-wider transition",
      ...
      >
          ...
          <div className="relative h-36 rounded-xl border-2 border-dashed border-border bg-muted/40 grid place-items-center overflow-hidden">
            {image ? (
              ...
              <div className="text-center text-muted-foreground">
                ...
                <div className="text-[11px] mt-1">Tap to upload</div>
              </div>
            )}
            <input
              type="file"
            ...
            {categories
              ...
              .map((c) => (
                <button
                  ...
                  className={cn(
                    "h-8 px-2.5 rounded-lg text-[12px] font-medium border",
                    category === c.id
        ...
        <div className="mt-3 grid grid-cols-2 gap-2">
          <button
            ...
            onClick={() => setVeg(!veg)}
            className={cn(
              "h-11 rounded-xl border text-sm font-medium inline-flex items-center justify-center gap-2",
              veg
